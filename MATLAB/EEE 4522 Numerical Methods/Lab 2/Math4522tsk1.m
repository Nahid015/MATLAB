...
AbsRelApproximateError(i) = abs((f(x) - sumpresent(i))/sumpresent(i))*100;
...
subplot(1,2,1);
plot(iteration,RelApproximateError,'LineWidth',2);
...
% Calculated.
subplot(1,2,2);
plot(iteration,AbsRelApproximateError,'LineWidth',2);
